...
export const FollowingIcon = ({ className, width = '2.5rem', height = '2.5rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
...
export const Notify = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
...
export const FriendsIcon = ({ className, width = '3rem', height = '3rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
...
export const ExploreIcon = ({ className, width = '2.8rem', height = '2.8rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
...
export const FollowingIconActive = ({ className, width = '2.5rem', height = '2.5rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
...
export const FriendsIconActive = ({ className, width = '2.8rem', height = '2.8rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
...
export const ExploreIconActive = ({ className, width = '2.8rem', height = '2.8rem' }) => (
    <svg
        fillRule="evenodd"
        className={className}
        width={width}
